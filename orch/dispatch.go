...
func (d *Dispatcher) handleSuccess(o TaskOutcome) {
	persisted := d.terminateAndRelease(o.Task, o.Worker.Name, StatusCompleted, Event{
		Kind: EventTaskCompleted, TaskID: o.Task.ID, Role: string(o.Task.Role()), Worker: o.Worker.Name,
...
func (d *Dispatcher) handleFailure(o TaskOutcome) {
	if d.retries.CanRetry(o.Task.ID, d.retryCfg) {
		...
		if err := d.store.UpdateTask(&retryTask); err != nil {
			...
			*o.Task = retryTask
			...
			d.emit(Event{Kind: EventTaskRetried, TaskID: o.Task.ID, Role: string(o.Task.Role()), Worker: o.Worker.Name,
	...
	persisted := d.terminateAndRelease(o.Task, o.Worker.Name, StatusFailed, Event{
		Kind: EventTaskFailed, TaskID: o.Task.ID, Role: string(o.Task.Role()), Worker: o.Worker.Name,
...
func (d *Dispatcher) handleBlocked(o TaskOutcome) {
	persisted := d.terminateAndRelease(o.Task, o.Worker.Name, StatusBlocked, Event{
		Kind: EventTaskBlocked, TaskID: o.Task.ID, Role: string(o.Task.Role()), Worker: o.Worker.Name,
...
func (d *Dispatcher) handleHandoff(ctx context.Context, o TaskOutcome) {
	...
	if ok {
		...
		d.emit(Event{Kind: EventTaskHandoff, TaskID: o.Task.ID, Role: string(o.Task.Role()), Worker: o.Worker.Name,
	...
	d.emit(Event{Kind: EventHandoffLimitReached, TaskID: o.Task.ID, Role: string(o.Task.Role()), Worker: o.Worker.Name,
...
func (d *Dispatcher) failOrphanedTask(taskID, workerName, summary string) bool {
	...
	persisted := d.terminateAndRelease(task, workerName, StatusFailed, Event{
		Kind: EventTaskFailed, TaskID: taskID, Role: string(task.Role()), Worker: workerName,
		Summary: summary,
	})
	if persisted {
...
func (d *Dispatcher) dispatch(ctx context.Context) (int, error) {
	...
	for _, task := range ready {
		...
		d.emit(Event{Kind: EventTaskDispatched, TaskID: task.ID, Role: string(role), Worker: worker.Name,
...
func (d *Dispatcher) failTaskAndRelease(task *Task, workerName string, reason error) {
	...
	d.emit(Event{Kind: EventTaskFailed, TaskID: task.ID, Role: string(task.Role()), Worker: workerName,
