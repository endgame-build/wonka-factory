...
var storeRegistry = map[LedgerKind]StoreConstructor{
	...
	LedgerBeads: func(dir string) (Store, error) { return NewBeadsStore(dir) },
}
...
// An empty kind defaults to LedgerBeads. Beads always falls back to LedgerFS
// when Beads/Dolt is unavailable; other explicit kinds do not fall back.
